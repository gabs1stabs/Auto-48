...
export default function Apropos() {
  ...
  const prevPage = ()=> setInterfaceCard((prev) => (prev - 1 + cards.length) % Math.ceil(cards.length / 2));

  const nextPageFedd=()=>setFeedbackinterface((prev)=>(prev+1)% Math.ceil(feedbacks.length));
  const prevPageFeed=()=>setFeedbackinterface((prev)=>(prev-1 + feedbacks.length)% Math.ceil(feedbacks.length));
  return (
    
    <section style={{overflowX:"clip"}}>
      <div className='flex  justify-center lg:scale-[1.9] lg:mt-16  '>
        <img src='./pics/design-r1.png' className='scale-[0.3] -mr-9 '></img>
        <p className='font-neo uppercase whitespace-nowrap text-[13px] mt-[0.93rem] leading-[100%] '>
          <span className=''>À propos de </span>
          <span className='text-[#C81717]'>nous</span>
        </p>
        <img src='./pics/design-r.png' className='scale-[0.3] -ml-9'></img>
      </div>
      ...
      <div className='bg-[#222222] grid grid-cols-12 lg:mt-5 frstComp '>
        ...
        {/* Background div with clip path */}
          ...
          <img src="./pics/about/image.jpg" className="w-[240px] h-[210px] ml-20 mb-10 -mt-1 scale-[0.9] translate-y-11 lg:scale-[1.2] lg:translate-x-[-11rem] lg:translate-y-28 md:scale-[1.1] md:translate-y-14 md:translate-x-[-2rem] xl:scale-[1.3] xl:translate-x-[-6rem] xl:translate-y-[6rem] 2xl:scale-y-[1.2] 2xl:translate-y-[5.4rem] mecanicpic"/>
         </div>
        </div>
          ...
          <div className='flex scale-[0.7] gap-28 -ml-[6.3rem] -mt-28  lg:justify-center  '>
              <img src='./pics/mobile/patternright.png'></img>
              <img src='./pics/mobile/patternleft.png' style={{clipPath:"polygon(20% 0%, 80% 0%, 42% 0, 85% 100%, 79% 100%, 20% 100%, 0 100%, 0 0)"}}></img>
            </div>
           <div className='flex  justify-center -mt-[30rem]'>
                <img src='./pics/design-r1.png' className='scale-[0.3] -mr-11'></img>
                <p className='font-neo uppercase whitespace-nowrap text-[13px] mt-[0.93rem] leading-[100%] '>
                    <span className=''>Pourquoi choisir </span>
                     <span className='text-[#C81717]'>Auto48?</span>
                 </p>
                <img src='./pics/design-r.png' className='scale-[0.3] -ml-11'></img>
            </div>
...
<div className="flex flex-col items-center justify-center gap-4 md:hidden mt-4 px-4">
  <div className="grid grid-cols-12 gap-4 px-14 mx-auto max-w-sm">
      ...
      <div key={card.id} className="bg-[#292929]  blackCard col-span-12 sm:col-span-10 sm:col-start-2 translate-y-7">
        <div className="m-3">
          ...
          <div className="absolute flex justify-between w-full px-36 mt-[30rem] translate-y-[-2rem] mobileVectors ">
            ...
            <img src='./pics/about/vectorright.svg'></img>
            </button>
            <button className="px-2 py-1 rounded" onClick={nextpage}>
            <img src='./pics/about/vectorleft.svg'></img>
            </button>
          </div>
        </div>
        {/**md view */}
    ...
    <div className="flex justify-center  w-full  md:mt-6 md:-ml-[4.3rem]">
      <button className=" px-2  py-1 rounded" onClick={prevPage}><img src='./pics/about/vectorright.svg'></img></button>
      <button className=" px-2   py-1 rounded" onClick={nextpage}><img src='./pics/about/vectorleft.svg'></img></button>
    </div>
      </div>
    </div>
    </div>       
  ...
  {/* Wrapper div for positioning context */}
  <div className="relative xl:mt-52">
    {/* Background gradient div with clip path */}
    ...
    {/* Car image positioned outside of the clipped container */}
    ...
    {feedbacks.slice(feedbackinterface, feedbackinterface + 1).map((feedback) => (
      <div key={feedback.id} className="relative shadow-xl col-span-6 translate-x-28 rounded-lg overflow-hidden">
        ...
        <div className="relative z-10 m-3 text-black">
          ...
          <p>{feedback.desc}</p>
          <div className="flex">
            <img src="./pics/about/stars.svg" className="scale-[0.8] mt-8 -ml-6" />
          </div>
        </div>
      </div>
    ))}
  ...
  <div className="absolute flex justify-center w-full  mt-64 translate-y-[-15rem] -ml-6 lg:-ml-12 2xl:-ml-32 xl:-ml-24 feedbackButtonsDesktop">
    ...
    <div className='w-full overflow-x-hidden lg:hidden'>
      <div className="flex w-max gap-6 animate-scrollLeft will-change-transform scrollbar-transparent">
      <img src='./pics/about/audi.svg'></img>
      <img src='./pics/about/bmw.svg'></img>
      <img src='./pics/about/ford.svg'></img>
      <img src='./pics/about/mercedes.svg'></img>
      <img src='./pics/about/peugeot.svg'></img>
      <img src='./pics/about/volk.svg'></img>
      </div>
    </div>
    {/**desktop view for marques */}
    <div className=" hidden lg:flex lg:justify-between lg:px-7 lg:mt-7">
      <img src='./pics/about/audi.svg'></img>
      <img src='./pics/about/bmw.svg'></img>
      <img src='./pics/about/ford.svg'></img>
      <img src='./pics/about/mercedes.svg'></img>
