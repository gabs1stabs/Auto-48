            ...
            <div className="flex">
              {images.map((src, i) => (
                <img
                  ...
                  3xl:w-[140px] 3xl:h-[95px] 3xl:mx-[70px] 4xl:w-[160px] 4xl:h-[105px] 4xl:mx-[90px] 5xl:w-[180px] 5xl:h-[115px] 5xl:mx-[120px]
                  6xl:w-[200px] 6xl:h-[125px] 6xl:mx-[130px] 7xl:w-[220px] 7xl:h-[135px] 7xl:mx-[140px] 8xl:w-[240px] 8xl:h-[145px] 8xl:mx-[150px] 
                   1xl:w-[260px] 1xl:h-[185px] 1xl:mx-[180px] "
                />
              ))}
            </div>
          </div>
...
<div className="flex top-7 xs:top-8 2xs:top-9 sm:top-[50px] md:mt-[120px] 2xl:mt-[160px] 3xl:mt-[180px] 4xl:mt-[240px]
  ...
  1xl:gap-[180px]">
    <div>
      <img src="/pics/apr-pic.png" alt="a propos picture" className="md:ml-3 mg:ml-0 md:w-[330px] md:h-[310px] mg:w-[370px] mg:h-[330px] lg:w-[420px] lg:h-[390px] xl:w-[480px] xl:h-[390px] 
