...
export default function Navbar() {
  ...
  return (
    <nav className="w-full z-[1000] lg:mt-2 2xl:mt-3 4xl:mt-4 6xl:mt-5">
      <div className="w-full font-space  items-center justify-between bg-gradient-to-r from-[#c23434] to-[#8e0d0d]  lg:flex hidden
      lg:p-[10px]  4xl:p-[12px_10px] 6xl:p-[14px_12px] 7xl:p-[16px_13px] ">
        <div className="flex items-center lg:gap-2 2xl:gap-3.5 1xl:gap-6 xl:ml-4 mr-0 6xl:ml-7 8xl:ml-10 1xl:ml-14 ">
          <a href="https://www.facebook.com/"><div className="bg-white py-[6px]  px-[8px]  2xl:py-[7px] 2xl:px-[11px] 6xl:py-[10px] 6xl:px-[13px] 8xl:py-[13px] 8xl:px-[16px] 1xl:py-[16px] 1xl:px-[20px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/facebook.svg"  alt="" className="lg:h-[19px] lg:w-[19px] 2xl:w-[30px] 2xl:h-[30px] 4xl:w-[31px] 4xl:h-[31px] 6xl:w-[33px] 6xl:h-[33px] 8xl:h-[36px] 8xl:w-[36px] 1xl:h-[39px] 1xl:w-[39px]" /></div></a>
          <a href="https://www.instagram.com/"><div className="bg-white py-[5px]  px-[7px]  2xl:py-[6.5px] 2xl:px-[10.5px] 4xl:py-[7px] 6xl:py-[9.5px] 6xl:px-[12px] 8xl:py-[12.5px] 8xl:px-[15px] 1xl:py-[14px] 1xl:px-[19px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/instagram.svg"  alt="" className="lg:h-[22px] lg:w-[22px] 2xl:w-[31px] 2xl:h-[31px] 4xl:w-[32px] 4xl:h-[32px] 6xl:w-[34px] 6xl:h-[34px] 8xl:h-[37px] 8xl:w-[37px] 1xl:h-[43px] 1xl:w-[43px]" /></div></a>
          <a href="https://www.tiktok.com/"><div className="bg-white py-[6px]  px-[8px]  2xl:py-[7px] 2xl:px-[11px] 6xl:py-[10px] 6xl:px-[13px] 8xl:py-[13px] 8xl:px-[16px] 1xl:py-[16px] 1xl:px-[20px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/tiktok.svg"  alt="" className="lg:h-[19px] lg:w-[19px] 2xl:w-[30px] 2xl:h-[30px] 4xl:w-[31px] 4xl:h-[31px] 6xl:w-[33px] 6xl:h-[33px] 8xl:h-[36px] 8xl:w-[36px] 1xl:h-[39px] 1xl:w-[39px]" /></div></a>
        </div>
        ...
        <div className="flex flex-grow  xl:justify-center items-center w-full">
          ...
          <div 
            ...
            <img src="/pics/phone.svg" alt=""  className="lg:h-[18px] lg:w-[18px] xl:h-[20px] xl:w-[26px] 2xl:h-[23px] 2xl:w-[29px] 4xl:h-[25px] 4xl:w-[32px] 6xl:h-[27px] 6xl:w-[34px] 8xl:h-[32px] 8xl:w-[37px] 1xl:h-[35px] 1xl:w-[40px]" />
            <a href="tel:+2120536716778"><span className="lg:mr-3 md:mr-2">05 36 716 778</span></a>
      ...
      <div className="w-full justify-center font-neo hidden lg:flex">
        <div className="xl:w-[60%] lg:w-[65%] 7xl:w-[57%] flex items-center justify-between relative top-9  3xl:top-10 5xl:top-11 6xl:top-12 7xl:top-13 8xl:top-14 ">
          ...
          <div className="relative left-3  lg:top-0.5 2xl:top-1 ">
            <img src="/pics/logo2.png" onClick={clickLogo} alt=""  className="w-[100px] h-[85px] xl:w-[115px] xl:h-[95px] 2xl:w-[130px] 2xl:h-[110px] 3xl:w-[140px] 3xl:h-[120px]  4xl:w-[150px] 4xl:h-[130px]  5xl:w-[170px] 5xl:h-[140px] 7xl:w-[200px] 7xl:h-[160px] 8xl:w-[220px] 8xl:h-[180px] 1xl:w-[250px] 1xl:h-[190px]" />
          </div>
      ...
      <div className="lg:hidden">
        <div className="flex justify-between items-center mx-4 my-4 border border-red-700 p-1">
          ...
          >
          <img src="/pics/menubtn.png" className=" bx-x w-6 mr-2" alt="" />
          </button>
        </div>
        
        <div className="flex justify-center mt-4 mb-2 md:mt-11">
          <img src="/pics/logo2.png" className="w-[110px] h-[85px] md:w-[130px] md:h-[95px]" alt=""  />
        </div>
      </div>
      <div className={`fixed top-0 left-0 w-full h-full bg-gradient-to-b from-red-800 to-red-950 z-[2000] flex flex-col items-center justify-center transition-all duration-200 ${isMenuOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}>
        ...
        <div className="flex flex-col items-center xxs:gap-3 gap-3 font-neo text-[10px] xs:text-[12px] md:text-[13px] 
        mg:text-[15px] w-[40%] sm:w-[30%] mg:w-[25%] ">
          <Link 
            to="/Acceuil" 
        ...
        <div className="absolute top-[75%] flex justify-center items-center gap-4">
          <div className="flex items-center gap-1 xs:gap-2 1xl:gap-6  ">
            <a href="https://www.facebook.com/"><div className="bg-white  py-[6px]  px-[7px] xs:py-[7px] xs:px-[8px] 2xs:py-[8px] 2xs:px-[9px] sm:py-[9px] sm:px-[10px] md:py-[11px] md:px-[12px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/facebook.svg"  alt="" className="h-[15px] w-[15px] xs:h-[17px] xs:w-[17px]  2xs:h-[19px] 2xs:w-[19px] sm:h-[21px] sm:w-[21px] md:h-[24px] md:w-[24px] " /></div></a>
            <a href="https://www.instagram.com/"><div className="bg-white py-[6px]  px-[7px] xs:py-[7px] xs:px-[8px] 2xs:py-[8px] 2xs:px-[9px] sm:py-[9px] sm:px-[10px] md:py-[11px] md:px-[12px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/instagram.svg"  alt="" className="h-[16px] w-[16px] xs:h-[18px] xs:w-[18px] 2xs:h-[20x] 2xs:w-[20px] sm:h-[22px] sm:w-[22px] md:h-[25px] md:w-[25px]" /></div></a>
            <a href="https://www.tiktok.com/"><div className="bg-white py-[6px]  px-[7px] xs:py-[7px] xs:px-[8px] 2xs:py-[8px] 2xs:px-[9px] sm:py-[9px] sm:px-[10px] md:py-[11px] md:px-[12px]"style={{clipPath: "polygon(22% 0, 78% 0, 100% 22%, 100% 78%, 78% 100%, 22% 100%, 0 78%, 0 22%)" }}><img src="/pics/tiktok.svg"  alt="" className="h-[15px] w-[15px] xs:h-[17px] xs:w-[17px]  2xs:h-[19px] 2xs:w-[19px] sm:h-[21px] sm:w-[21px] md:h-[24px] md:w-[24px]" /></div></a>
          </div>
        </div>
