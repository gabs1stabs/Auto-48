          ...
          <div className='lg:hidden mx-[10%] xs:mx-[11%] 2xs:mx-[12%] sm:mx-[13%] md:mx-[15%] my-5 xs:my-6'>
            <div className='flex items-center mb-6'>
              ...
              <div>
                ...
                <p className='font-turret text-[11px] xs:text-[12px] sm:text-[13px] mg:text-[15.5px]'>05 36 716 777</p>
          ...
          <div className='lg:block hidden mx-12 xl:mx-[55px] 2xl:mx-[65px] 3xl:mx-[75px] 4xl:mx-[80px] 5xl:mx-[85px] my-5 2xl:my-7 5xl:my-10'>
            <div className='flex items-center mb-6 '>
              ...
              <div>
                ...
                <p className='font-turret text-[12px] 2xl:text-[14.5px] 3xl:text-[16.5px] 4xl:text-[19px] 5xl:text-[21.5px] 6xl:text-[22.5px]'>05 36 716 777</p>
                <p className='font-turret text-[12px] 2xl:text-[14.5px] 3xl:text-[16.5px] 4xl:text-[19px] 5xl:text-[21.5px] 6xl:text-[22.5px]'>05 36 716 778</p>
              </div>
            </div>
